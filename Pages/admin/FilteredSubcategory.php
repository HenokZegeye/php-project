...
<html>
    ...
    <body>
        ...
        <table border="1">
                ...
                $query1="SELECT Subcategory_Id, Subcategory_Name FROM product_subcategory psc, product_category pc WHERE psc.Category_Id=pc.Category_Id AND pc.Category_Id=".$Cat_Id;
                include_once '../../Class/Connection.php';
                $read = new Connection();
                $result;
                ...
                if($Cat_Id!="NULL"){
                    ...
                    header("location:SubcategoryPage.php");
                }
